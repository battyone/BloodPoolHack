...
<head>
    <title>BloodPool | WHY SHOULD YOU DONATE? </title>
                ...
                <div class="container">
                    ...
                    <div class="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="blog.jsp">blog</a></li>
                            <li class="active">Why should you donate blood?</li>
                        </ol>
                    </div>
                    <!-- end bread-crumb -->
                </div>
...
Some believe it is the right thing to do.  Here are the reasons why blood donation is important for the society, and for you.
                            ...
                            <div class="post_small-title text-left">
                                <h2><strong>Why blood donation is important for the society?</strong></h2><br/>
                                <span class="hexo-under-title"></span>
                                <p class="main-paragraph">Here are some facts that showcase the growing need for an increase in the number of blood donors.</p>
