                ...
                <div class="container">
                    <div class="blog-left col-md-9 col-xs-12 pull-left text-center">
                        <div class="blog_left-post">
                            <div class="post-img">
                                <img src="images/blood-drive.png" alt="" class="img-responsive">
                            </div>
                            <!-- end post-img -->
                            ...
                            <div class="post-description">
                                <p>
                                  You have no new notifications. This area shows you requests you receive from various people for blood Donations. The requests are filtered based on the proximity of the Hospital's location with your location.
                                </p>
                            </div>
