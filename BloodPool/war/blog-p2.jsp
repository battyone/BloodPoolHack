                    ...
                    <div class="blog-left col-md-9 col-xs-12 pull-left text-center">
                        <div class="blog_left-post">
                            ...
                            <div class="post-description">
                                ...
                                Learn about the reasons that stop us and which of these reasons are actually justified.
                                </p>
                            </div>
                            <!-- end post-description -->
                            <div class="post-more">
                                <a href="single-blog4.jsp">read more</a>
                            </div>
                            <!-- end post-more -->
                        </div>
                        <!-- end blog_left-post -->
                        ...
                        <div class="post-pagination">
                            <a class="preview-left" href="blog.jsp">
